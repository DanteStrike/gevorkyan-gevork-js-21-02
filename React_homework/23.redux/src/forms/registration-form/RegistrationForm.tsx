  ...
  return (
    <>
      ...
      >
        ...
        <Form.Item name="picture" label="Picture" rules={[{type: 'url', message: 'Must be valid url'}]}>
          <Input />
        </Form.Item>
        ...
        <Form.Item
          name="phone"
          label="Phone"
          rules={[{pattern: new RegExp(`^\\+?7(\\d{10})$`), message: 'Input valid phone'}]}
        >
          <Input />
        </Form.Item>

        <Form.Item name={[`location`, `street`]} label="Street">
          <Input />
        </Form.Item>
        ...
        <Form.Item name={[`location`, `timezone`]} label="Timezone">
          <Select>
